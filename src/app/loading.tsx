...
const PathFinder = () => {
  ...
  return (
    <div
      ...
      className="grid w-[55vmin] border-l border-t border-neutral-800 bg-neutral-950 shadow-2xl shadow-neutral-900"
    >
      {generateBoxes()}
    </div>
  );
...
const Loading = () => {
  return (<>
    <div className="grid h-screen w-full place-content-center bg-neutral-950 z-100">
      <PathFinder />
       <div className='py-5 font-bold text-xl'>Good Things Take Time <br />- KintsugiDevStudio 💜</div>
