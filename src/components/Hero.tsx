    ...
    <div className="relative md:h-[20rem] h-[40rem] flex flex-col md:flex-row items-center justify-center">
      ...
      <div className="relative mb-8 md:mb-0">
        ...
        <div className='pt-5 flex md:flex-row '> {/* flex-col */}
          <div><a href="https://drive.google.com/file/d/1LOZOUv14uruI2EmhzWgqRFNESP1pk9tg/view?usp=sharing" target="_blank" rel="noopener noreferrer">
        ...
        Résumé
</button></a></div><div className='ml-2'>
...
<div className=' mt-2'>
<Link href="https://design-thinking-kds.my.canva.site/" target="_blank" rel="noopener noreferrer"><button className=" shadow-[0_0_0_3px_#000000_inset] px-6 py-2 bg-transparent border border-green-500 text-green-border-green-500 rounded-lg font-bold transform hover:-translate-y-1 transition duration-400"><span className="font-bold" >&gt; </span>
